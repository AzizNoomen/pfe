...
from app.schemas.document_schema import DocumentSchema, DocumentCreateSchema, DocumentUpdateSchema
...
@router.post("/create/documents/", response_model=DocumentSchema)
...
@router.get("/get/document/{id}", response_model=DocumentSchema)
...
@router.put("/update/documents/{id}", response_model=DocumentSchema)
...
@router.delete("/delete/documents/{id}", response_model=dict)
...
@router.get("/get/documents", response_model=List[DocumentSchema])
def get_document():
